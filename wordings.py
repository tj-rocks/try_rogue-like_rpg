...
class Text:
    ...
    class System:
        GAME_OVER = "死んでしまった\n総資産（手持ち＋預金＋所持品）が半分になり、死の呪いが進行した"
    ...
    class NPC:
        ...
        PRIEST_NO_GOLD = "ゴールドが足りないようです \n呪いの解除には {gold_cost} G必要です"
        PRIEST_CURE_CONFIRM = "ギルドポイント(GP)を {cost} GP、さらに治療代として\n{gold_cost} G捧げることで、死の呪いを1段階解除できます\n儀式を行いますか？"
